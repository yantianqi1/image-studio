...
const navItems = [
  ...
  { href: "/admin/billing", label: "计费", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
  )},
  { href: "/admin/redeem", label: "激活码", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
  )},
  { href: "/admin/providers", label: "Provider", icon: (
  ...
  { href: "/admin/image-jobs", label: "图片任务", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
  )},
  { href: "/admin/comic-jobs", label: "漫画任务", icon: (
...
type AdminShellProps = Readonly<{ title: string; description: string; children: React.ReactNode; }>;
    ...
    <div className="admin-root">
      ...
      <main className="admin-main">
        <section className="admin-hero">
          <p className="admin-eyebrow">Admin Web</p>
