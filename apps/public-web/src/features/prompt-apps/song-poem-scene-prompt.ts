...
请根据【对应诗词】生成一张中国古典诗意场景图。

这幅画不限定具体朝代或诗体。请从【对应诗词】中自动提炼时间、地点、人物关系、核心意象与情绪张力，可适配唐诗、词、曲、古风诗句或其他中国古典诗意文本。
...
【对应诗词】应作为这幅画的情绪来源与文字气口，可以自然出现在画面角落、题签、题跋或诗笺上，但不要喧宾夺主；如果画面出现文字，必须清晰、雅致、少量，并与中国古典美学融合。
...
export function buildSongPoemScenePrompt(input: SongPoemScenePromptInput) {
  ...
  const poemLine = note ? `【对应诗词】= {${poem}}（${note}）` : `【对应诗词】= {${poem}}`;
