...
def persist_rendered_asset(session: Session, *, storage_dir: Path, rendered, user_id: int | None) -> Asset:
...
def create_pending_asset(session: Session, *, mime_type: str, owner_user_id: int | None) -> Asset:
    asset = Asset(
