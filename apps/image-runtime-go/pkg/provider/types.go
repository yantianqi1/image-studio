...
var supportedRenderProviderTypes = []string{
	OpenAICompatibleType,
	OpenAIChatCompatibleType,
	OpenRouterChatImageType,
}

func SupportedRenderProviderTypes() []string {
	return append([]string(nil), supportedRenderProviderTypes...)
}
